...
The WG is responsible for coordinating and dispatching performance measurement related work within the IETF. It specifically coordinates with other WGs such as MPLS, 6MAN, and SPRING where encapsulations are specified.

The WG closely collaborates with the Performance Metrics Directorate per the guidance in BCP 170.

The WG liaisons with other Standards Development Organizations such as ITU-U, IEEE, 3GPP, and BBF and reaches out to other operator communities such as NANOG, RIPE, and APRICOT.
